  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.particlesContainer}>
        <div style={{ ...styles.particle, top: '20%', left: '15%', animationDelay: '0.5s' }} />
        <div style={{ ...styles.particle, top: '65%', left: '75%', animationDelay: '2.5s' }} />
        <div style={{ ...styles.particle, top: '35%', left: '85%', animationDelay: '1.5s' }} />
        <div style={{ ...styles.particle, top: '80%', left: '30%', animationDelay: '3.5s' }} />
        <div style={{ ...styles.particle, top: '10%', left: '70%', animationDelay: '4.5s' }} />
      </div>
        ...
        <div style={styles.formCard}>
          ...
          <div style={{ padding: '36px 36px 32px' }}>
            <div style={{ marginBottom: '24px' }}>
              <Title level={3} style={styles.formTitle}>Create Account</Title>
              <Text style={styles.formSubtitle}>
                Get access to AI-powered match predictions
              </Text>
            </div>
