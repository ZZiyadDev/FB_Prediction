...
import { Card, Row, Col, List, Avatar, Divider, Tag, Empty, Space } from 'antd';
...
const MatchLineup = ({ lineup, homeTeamName, awayTeamName }) => {
  ...
  return (
    <Card bordered={false} style={{ background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
      <Row gutter={48}>
        <Col span={12}>
          <LineupSection 
